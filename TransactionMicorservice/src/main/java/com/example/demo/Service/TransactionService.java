...
public class TransactionService {
	...
	public Iterable<Transaction> getLentBooks(String trxntype) {
	  ...
	  { 
		  ...
		  logger.info("Transaction Service getting Response from Customer-Service : "+new ObjectMapper().writeValueAsString(customer)); Book book =
		  resttemplate.getForObject("http://BOOK-SERVICE/api/book/"+transaction.getBookid(), Book.class); 
